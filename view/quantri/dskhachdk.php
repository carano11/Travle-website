...
<body>
	...
	<table id="abc">
		...
		<?php
			include("../../model/quantri/pagination_dskhach.php");
			...
			<tr>
				...
				<td><button type="button" class="btn btn-info" onclick="confDelete()"><a id="demo" href="../../model/quantri/delete_customer.php?id=<?php echo $customer['ID']?>">Xóa</a></button></td>
