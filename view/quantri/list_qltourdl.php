...
<?php 
	...
	<table id="abc" width="1000px" align="center" border="1 solid" cellpadding="5">
		...
		<?php
		 	include("../../model/quantri/pagination_listtour.php");
			...
			<tr>
				...
				<td align="center">
					<button type="button" class="btn btn-danger" ><a href="../../view/quantri/show_tour_details.php?id=<?php echo $row['ID'] ?>" style="color: black">Chi tiết</a></button>

					<a id="demo" href="../../model/quantri/delete_tour.php?id=<?php echo $row['ID'] ?>"><input type="button" value="Xóa" class="btn btn-info" onclick="confDelete()"></a>
				</td>
			</tr>			
			<?php 
		}
	...
	<script type="text/javascript" src="../../model/quantri/1.js"></script>
</body>
</html>