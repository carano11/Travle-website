...
<head>
	...
	<?php 
	include("../../model/quantri/permission.php");
	?>
	<title></title>
</head>
<body>
	...
	<table id="abc" width="1150px" align="center" border="1 solid" cellpadding="5">
		...
		<?php
			include("../../model/quantri/pagination_listemployees.php");
			...
			<tr>
				...
				<td>
					...
					<button value="Xóa" class="btn btn-info" onclick="confDelete()">
						<a id="demo" href="../../model/quantri/delete_employee.php?id=<?php echo $employee['ID'] ?>">Xóa
						</a>
					</button>
